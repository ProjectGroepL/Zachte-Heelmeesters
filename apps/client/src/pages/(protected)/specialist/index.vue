...
<template>
  <main class="max-w-6xl mx-auto p-6 space-y-6">
    ...
    <p v-else-if="visibleAppointments.length === 0" class="text-gray-400 italic">
      Geen afspraken met goedgekeurde toegang.
    </p>

    <section v-for="appointment in visibleAppointments" :key="appointment.id" class="border rounded-2xl p-5 space-y-4">
      <header>
